...
$table = $installer->getConnection()
    ->newTable($installer->getTable('vendor/product_eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('vendor/product_eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('vendor/product_eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('vendor/product_eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
