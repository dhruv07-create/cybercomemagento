...
class Ccc_Practice_Block_Adminhtml_Practice_Set_Main_FormGroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('attribute_group_name', 'text',
            array(
                'label'    => Mage::helper('catalog')->__('Naaame'),
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/practice_group/save'));
        $this->setForm($form);
    }
