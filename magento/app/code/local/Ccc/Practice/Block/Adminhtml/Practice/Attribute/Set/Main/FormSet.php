...
class Ccc_Practice_Block_Adminhtml_Practice_Attribute_Set_Main_FormSet extends Mage_Adminhtml_Block_Widget_Form
 {
   ...
   public function __construct()
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('practice')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('practice')->__('Name'),
            'note' => Mage::helper('practice')->__('For internal use.'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('practice')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
