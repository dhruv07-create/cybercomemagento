...
class Ccc_Vendor_Adminhtml_Vendor_AttributeController extends Mage_Adminhtml_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendor_attribute'));
    ...
    {	
      ...
      /*  $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendor_attribute_edit'));

        $this->_addLeft($this->getLayout()->createBlock('vendor/adminhtml_vendor_attribute_edit_tabs'));

        $this->_addJs($this->getLayout()->createBlock('adminhtml/template')->setTemplate('vendor/attribute/js.phtml'));
*/
