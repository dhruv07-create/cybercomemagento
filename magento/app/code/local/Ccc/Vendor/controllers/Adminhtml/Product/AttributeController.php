...
class Ccc_Vendor_Adminhtml_Product_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    {	
        ...
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_edit'));

        $this->_addLeft($this->getLayout()->createBlock('vendor/adminhtml_product_attribute_edit_tabs'));
