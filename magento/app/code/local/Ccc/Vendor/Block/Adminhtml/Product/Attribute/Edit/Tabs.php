...
class Ccc_Vendor_Block_Adminhtml_Product_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('vendor/adminhtml_product_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
      ...
      /*  if ('select' == $model->getFrontendInput()) {
            $this->addTab('options_section', array(
                ...
                'content'   => $this->getLayout()->createBlock('vendor/adminhtml_product_attribute_edit_tab_options')->toHtml(),
            ));
        }*/
