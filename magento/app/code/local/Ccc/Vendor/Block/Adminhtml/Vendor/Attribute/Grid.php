...
class Ccc_Vendor_Block_Adminhtml_Vendor_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
    ...
    {
        $entity_type_id = Mage::getModel('eav/entity')->setType('vendor')->getTypeId();
        $collection = Mage::getResourceModel('eav/entity_attribute_collection')->addFieldToFilter('entity_type_id',$entity_type_id);
