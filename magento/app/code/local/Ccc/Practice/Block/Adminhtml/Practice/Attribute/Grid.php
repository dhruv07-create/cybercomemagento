...
class Ccc_Practice_Block_Adminhtml_Practice_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{

    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(Ccc_Practice_Model_Resource_Practice::ENTITY)->getTypeId());
