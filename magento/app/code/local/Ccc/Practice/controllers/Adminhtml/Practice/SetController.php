...
class Ccc_Practice_Adminhtml_Practice_setController extends Mage_Adminhtml_Controller_Action
{
   
   protected function _setTypeId()
    {
        Mage::register('entityType',
            Mage::getModel('practice/practice')->getResource()->getTypeId());
    } 
    ...
    public function indexAction()
	{
        ...
        $this->_addBreadcrumb(Mage::helper('practice')->__('Practice'), Mage::helper('practice')->__('Practice'));
        $this->_addBreadcrumb(
            Mage::helper('practice')->__('Manage vendor Sets'),
            Mage::helper('practice')->__('Manage vendor Sets'));

        $this->_addContent($this->getLayout()->createBlock('practice/adminhtml_practice_attribute_set_toolbar_main'));
      
        $this->_addContent($this->getLayout()->createBlock('practice/adminhtml_practice_attribute_set_grid'));
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('practice/adminhtml_practice_attribute_set_toolbar_add'));
  ...
  public function editAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('practice')->__('practice'), Mage::helper('practice')->__('practice'));
        $this->_addBreadcrumb(
            Mage::helper('practice')->__('Manage practice Attribute Sets'),
            Mage::helper('practice')->__('Manage practice Attribute Sets'));

        $this->_addContent($this->getLayout()->createBlock('practice/adminhtml_practice_attribute_set_main'));
...
public function saveAction() {
        ...
        try
        {
            if ($isNewSet) {
                ...
                if (!$model->getId()) {
                    Mage::throwException(Mage::helper('practice')->__('This attribute set no longer exists.'));
                }
