...
class Ccc_Vendor_Block_Adminhtml_Product_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    ...
    {
        return $this->getUrl('vendor1/adminhtml_product_set/save', array('id' => $this->_getSetId()));
    }
    ...
    { 
        ...
        foreach ($groups as $node) {
            ...
            $nodeChildren = Mage::getResourceModel('vendor/product_productattribute_collection')
